  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold text-center text-accent mb-6">
        Begin Your Journey to Protection
      </h1>
        ...
        <fieldset>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.nid && (
                <p className="text-red-500 text-sm">NID/SSN is required</p>
              )}
            </div>
          </div>
        </fieldset>
        ...
        <fieldset>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              {errors.nomineeName && (
                <p className="text-red-500 text-sm">Nominee name is required</p>
              )}
            </div>
            <div>
            ...
            <div className="md:col-span-2">
              ...
              <input
                {...register("nomineeNid", { required: true })}
                className="input input-bordered w-full"
              />
              {errors.nomineeNid && (
                <p className="text-red-500 text-sm">Nominee NID is required</p>
              )}
            </div>
          </div>
        </fieldset>
